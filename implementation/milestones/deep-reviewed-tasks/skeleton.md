...
{"slices":[
  ...
  {"id":2,"title":"Review breadth, debt, and caps","intent":"Make one- or two-family breadth, applicable debt posture, existing convergence caps, and implementation size controls order choices while keeping two distinct families and current debt behavior as the default.","producer_task_executor":{"draft_slice_note":"agent_call","implement":"agent_call"}},
