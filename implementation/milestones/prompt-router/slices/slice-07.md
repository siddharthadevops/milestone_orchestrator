...
| Rethink payload and craft follow the charge | `test_rethink_payload_mount_is_exact_for_every_seat`; `test_rethink_artifact_type_follows_the_target` | Every seat receives the complete finding exactly once; document targets receive document craft and code targets implementation craft, independent of the origin unit. |
