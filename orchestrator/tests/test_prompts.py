...
class TestPlannerMaterialChannel(unittest.TestCase):
    """Slice material is absent from every plan-authoring prompt."""

    def _plan_authoring_prompts(self):
    ...
    def test_material_channel_is_absent_from_every_plan_author(self):
