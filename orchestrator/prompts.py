...
def _producer_review_block(context):
    ...
    return (
        ...
        "is always a finding. Compare each visible producer and optional\n"
        "material value directly with this canonical projection. A material\n"
        "names a KIND OF WORK, never an agent, model, or effort, and is not\n"
        "checked against any catalogue here.\n"
